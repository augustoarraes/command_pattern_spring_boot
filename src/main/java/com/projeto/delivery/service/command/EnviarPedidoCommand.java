...
public class EnviarPedidoCommand implements PedidoCommand  {
	
	private PedidoService pedidoService;
    private UUID pedidoId;

    public EnviarPedidoCommand(PedidoService pedidoService, UUID pedidoId) {
	...
	public PedidoResponseDTO execute() {
		return pedidoService.enviarPedido(pedidoId);
	}
